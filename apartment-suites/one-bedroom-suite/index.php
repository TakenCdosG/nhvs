...
<body>
    ...
    <div class="cycle-slideshow room-slideshow" data-cycle-fx="scrollHorz" data-cycle-swipe="true" data-cycle-timeout="3000" style="position: relative;">
        ...
        <img src="../../images/galleries/one-bedroom-suite-1.jpg" class="cycle-slide" style="position: absolute; top: 0px; left: 0px; z-index: 95; visibility: hidden;">
    </div>
    
    <p>With a private exterior access, our one bedroom suites are spacious and inviting. The suite offers a separate bedroom with queen or king size bed, bathroom, and an HD TV. A fully equipped kitchen is offered along with a dining and living area with a sofa bed. And let’s not forget the fireplaces featured in each suite to cozy up to with your loved ones.</p>
    ...
    <section class="right-sidebar">
        ...
        <h3>Gallery</h3>
        <div>
            <a href="../../images/galleries/one-bedroom-suite-1.jpg" data-lightbox="one-bedroom-suite">
                <img src="../../images/galleries/thumb/one-bedroom-suite-1.jpg">
            </a>
            <a href="../../images/galleries/3-1-Room-One-Bedroom-king.png" data-lightbox="one-bedroom-king-suite">
                <img src="../../images/galleries/thumb/3-1-Room-One-Bedroom-king.png">
            </a>
        </div>    
    </div>
