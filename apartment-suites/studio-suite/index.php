...
<body>
    ...
    <div class="cycle-slideshow room-slideshow" data-cycle-fx="scrollHorz" data-cycle-swipe="true" data-cycle-timeout="3000" style="position: relative;"><img src="../../images/galleries/nhvs-interior-3.jpg" class="cycle-slide cycle-sentinel" style="position: static; bottom: 0px; left: 0px; z-index: 100; opacity: 1; display: block; visibility: hidden;">        
   <img src="../../images/galleries/nhvs-interior-1.jpg" class="cycle-slide" style="position: absolute; bottom: 0px; left: 0px; z-index: 99; visibility: hidden;"><img src="../../images/galleries/executive-studio-suite-3.jpg" class="cycle-slide" style="position: absolute; bottom: 0px; left: 0px; z-index: 96; visibility: hidden;">
   <img src="../../images/galleries/executive-studio-suite-4.jpg" class="cycle-slide" style="position: absolute; bottom: 0px; left: 0px; z-index: 93; visibility: hidden;"></div>
    
    <p>Our spacious, 600 square foot studio suites offer your choice of a king or two double beds. Additional space includes a living room complete with sofa bed, dining area, and a fully equipped kitchen. The majority of studio suites also have fireplaces to get cozy on those chilly New England fall nights.</p>
    ...
    <ul class="list col-list amenities-list">
        ...
        <li style="background-image:url('../../images/icons/amenities/fireplace.png')">Fireplace <em>(located in most suites)</em></li>
    ...
    <section class="right-sidebar">
        ...
        <div>
            ...
            <a href="../../images/galleries/executive-studio-suite-3.jpg" data-lightbox="executive-studio">
                <img src="../../images/galleries/thumb/executive-studio-suite-3.jpg">
            </a>
            <a href="../../images/galleries/1-1-Room-STUDIO-king.png" data-lightbox="executive-studio">
                <img src="../../images/galleries/thumb/1-1-Room-STUDIO-king.png">
            </a>
            <a href="../../images/galleries/1-2-Room-STUDIO-queen.png" data-lightbox="executive-studio">
                <img src="../../images/galleries/thumb/1-2-Room-STUDIO-queen.png">
            </a>
        </div>    
    </div>
